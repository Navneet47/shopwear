  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Shopnation.com - Shop Anything you want from tshirts to shoodies to mugs and lots more"
        />
        ...
        <section id="carousel" className="border border-b-4 mb-6">
          <div className="max-w-[600px] h-[580px] sm:max-w-[1200px] sm:h-[680px] w-full m-auto py-16 px-4 relative group">
            <div
              ...
              className="max-w-full h-full rounded-xl bg-center bg-contain bg-no-repeat duration-500"
            ></div>
                    ...
                    return (
                      <Link key={index} href={item.link} className="group">
                        <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                          ...
                          />
                          <h3 className="p-2 text-xl text-center uppercase bg-white">
                            {item.name}
                          </h3>
                        </div>
                      </Link>
                      ...
                      <div className="mt-4 flex justify-between">
                        <div>
                          ...
                          <div className="flex gap-2">
                            <p className="mt-1 text-md font-semibold text-black ml-2 mb-1">
...
export async function getServerSideProps(context) {
  ...
  let products = [tshirts[0],hoodies[0],mugs[0],sneakers[0]];
  return {
