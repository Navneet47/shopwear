                    ...
                    <div className="ml-4 flex flex-1 flex-col">
                      ...
                      <div className="flex flex-1 items-end justify-between text-sm mt-2">
                        <div className="flex items-center border-gray-100">
                          ...
                          <p className="py-1 px-3.5 border bg-white text-center text-xs outline-none">
                            {cart[item].qty}
                          </p>
                          <span
                            onClick={() => {
                            ...
                            className="cursor-pointer rounded-r bg-gray-100 py-1 px-3 duration-100 hover:bg-orange-500 hover:text-orange-50"
                          >
                            {" "}
                            +{" "}
                          </span>
          ...
          <div className="mx-4">
            <Link href={"/checkout"}>
              <button
                ...
                className=" disabled:bg-orange-200   flex mr-2 text-white bg-orange-500 border-0 py-2 px-3 focus:outline-none hover:bg-orange-600 rounded text-md"
              >
                <BsFillBagCheckFill className="m-1 mt-1" />
                Pay
              </button>
            </Link>
          </div>
