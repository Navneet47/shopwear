    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/51PUMIBLvoL._UL1300_.jpg"/>
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">SHOPHEAVEN</h2>
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Blue T-shirt</h1>
              ...
              <div className="flex">
                ...
                <button onClick={()=>{addToCart(slug, 1, 499, "T-shirt", 'XL', 'Blue')}} className="flex ml-8 text-white bg-orange-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-orange-600 rounded text-sm">Add to Cart</button>
                <button className="flex ml-4 text-white bg-orange-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-orange-600 rounded text-sm">Buy Now</button>
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                <input placeholder='Check Serviceability' onChange={onChangePin} type='text' className='px-2 border-2 border-gray-400 rounded-md focus:outline-orange-500 hover:bg-orange-100'/>
